...
- [JS summary](#js-summary)
  - [1. 자바스크립트의 특징은 무엇인가요?](#1-자바스크립트의-특징은-무엇인가요)
  - [2. JavaScript는 어떤 언어인가요?](#2-javascript는-어떤-언어인가요)
  - [3. 실행 컨텍스트란 무엇인가요?](#3-실행-컨텍스트란-무엇인가요)
    - [3.1. 구성요소에 대한 설명해주세요](#31-구성요소에-대한-설명해주세요)
    - [3.2. Lexical Environment의 구성요소에 대해 설명해주세요](#32-lexical-environment의-구성요소에-대해-설명해주세요)
  - [4. 호이스팅이 무엇인가?](#4-호이스팅이-무엇인가)
    - [4.1. 함수 표현식은 어떻게 되나?](#41-함수-표현식은-어떻게-되나)
  - [5. 스코프란 무엇인가?](#5-스코프란-무엇인가)
    - [5.1. 스코프 체인이 무엇인가?](#51-스코프-체인이-무엇인가)
    - [5.2. 렉시컬 스코프란 무엇인가?](#52-렉시컬-스코프란-무엇인가)
    - [5.3. 전역 스코프 문제점은 무엇인가?](#53-전역-스코프-문제점은-무엇인가)
...
### 3.2. Lexical Environment의 구성요소에 대해 설명해주세요
